...
export default function Footer(){
    return(
        <div>
            ...
            <nav className='flex justify-center flex-wrap gap-6 text-grey-500 font-medium bg-gradient-to-r from-black to-grey-700'>
    ...
    <a className='hover:text-cyan-500 text-amber-500' href='#'> Contact </a>
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-sm mt-8 text-gray-300">"At Cheezeria  Pizza, we bring you the authentic taste of freshly baked pizzas made with love and the finest ingredients. Whether you're craving a classic Margherita or a loaded pepperoni, we've got you covered. Order online or visit us to experience a slice of happiness today!"
           <a href='javascript:void(0)' className="text-sm font-semibold text-blue-500">Read
            more...</a></p>
      ...
      <ul className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-12 mt-20">
        ...
        <li className="flex items-center">
          ...
          <a href="javascript:void(0)" className="text-gray-300 text-sm ml-3">
            ...
            <strong>info@Cheezeria Pizza.com</strong>
          </a>
        </li>
        <li className="flex items-center">
          <div className="bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
          ...
          <a href="javascript:void(0)" className="text-gray-300 text-sm ml-3">
            ...
            <strong>bhadurabad Main Street karachi , pakistan</strong>
          </a>
        </li>
        <li className="flex items-center">
          <div className="bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
      ...
      <div className="flex max-md:flex-col gap-4">
        ...
        <p className='text-sm text-gray-300 md:ml-auto'>© Cheezeria Pizza. All rights reserved.</p>
      </div>
    </footer>
    </div>
    );
