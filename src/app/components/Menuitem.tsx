...
import { Product } from "@/pages/types"; // Ensure Product type is used if needed
    ...
    return (
        <div className="relative min-h-screen py-6">
            <div
                ...
                style={{
                    backgroundImage: "url('/images/back.jpg')", // Fixed typo from 'ur' to 'url'
                }}
            ></div>
            <div className="relative z-10">
                <div className="max-w-6xl mx-auto text-center mb-8">
                    <h1 className="text-4xl font-bold text-white mb-4">
                        Delicious Food Item In Our Menu
                    </h1>
                    <p className="text-xl text-white">
                        Explore our selection of mouth-watering food to order now!
                    </p>
                </div>
                ...
                <button
                    ...
                    {showCart && (
                        <div className='mt-6 bg-white-p-6 rounded-lg shadow-lg'>
                            <h2 className='text-4xl font-bold mb-4 text-blue-600'>Your Cart Items are Include</h2>
                            {cart.length > 0 ?(
                                <div>
                                <ul>
                            ...
                            <div className='flex justify-between items-center mt-6 text-black '>
                                ...
                                <div>
                                    ...
                                    <button
                                        onClick={clearCart}
                                        className='bg-red-600 py-3 px-8 rounded-lg ml-4 text-lg shadow-md hover:g-red-700 transition duration-300 ease-in-out text-white transform hover:scale-110'>
                                            Clear Cart
                                    </button>
                                </div>
                        ...
                        <div className='bg-white p-8 rounded-lg shadow-lg w-full sm:w-96'>
                            ...
                            <div className='mt-4'>
                                <ul>
                                    {cart.map((product, index) => (
                                        <li
                                            key={index} className='flex justify-between mb-4'>
                            ...
                            <div className='mt-6 flex justify-between'>
                                ...
                                <button
                                onClick={() => alert ('Thankyou for order confirm .. will deliver at your door step !')}
